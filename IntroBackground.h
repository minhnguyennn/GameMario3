...
#define INTRO_BACKGROUND_STATE_GO_WORLD_MAP		2
//time
#define TIME_BACKGROUND_CHANGE_SCENE_1			1000
#define TIME_BACKGROUND_CHANGE_SCENE_2			6000
#define TIME_BACKGROUND_CHANGE_SCENE_3			1000
#define TIME_BACKGROUND_500						500
//POSITION ADJUST
#define INTRO_BACKGROUND_Y_100					100
#define INTRO_BACKGROUND_Y_50					50
#define INTRO_BACKGROUND_X_86					86
#define INTRO_BACKGROUND_X_40					40
